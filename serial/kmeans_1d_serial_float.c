/*
 * kmeans_1d_serial_float.c
 * Versão sequencial convertida para 'float'
 * Este é o baseline CORRETO para comparar com a versão CUDA.
 */
...
static void update_step_1d(const float *X, float *C, const int *assign, int N, int K){
    double *sum = (double*)calloc((size_t)K, sizeof(double)); // Usar double para soma é OK
...
int main(int argc, char **argv){
    ...
    printf("Iniciando K-means 1D (Serial, FLOAT)\n");
    ...
    printf("\nK-means 1D (Serial, FLOAT) finalizado.\n");
